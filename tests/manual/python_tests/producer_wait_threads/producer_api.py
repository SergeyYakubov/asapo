...
producer  = asapo_producer.create_producer(endpoint,'processed',beamtime, 'auto', data_source, token, nthreads, 600)
...
# create with error
try:
    producer  = asapo_producer.create_producer(endpoint,'processed',beamtime,'auto', data_source, token, 0, 600)
