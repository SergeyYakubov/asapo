...
REM worker
"%2" %proxy_address% %beamtime_id1% 2 %token1% 1000 | findstr /c:"Processed 1000 file(s)"  || goto :error
"%2" %proxy_address% %beamtime_id2% 2 %token2% 1000 | findstr /c:"Processed 900 file(s)"  || goto :error
