...
class GenericValue {
  ...
  GenericValue(Object o) RAPIDJSON_NOEXCEPT :
    ...
    */
    ...
    template <typename SourceAllocator> ConstMemberIterator FindMember(const GenericValue<Encoding, SourceAllocator>& name)
    const {
        return const_cast<GenericValue&>(*this).FindMember(name);
    }
    ...
    GenericValue& AddMember(GenericValue& name, GenericValue& value, Allocator& allocator) {
        ...
        if (o.size >= o.capacity) {
            if (o.capacity == 0) {
                ...
                SetMembersPointer(reinterpret_cast<Member*>(allocator.Realloc(GetMembersPointer(), oldCapacity * sizeof(Member),
    ...
    */
    double GetDouble() const {
        ...
        if ((data_.f.flags & kInt64Flag) != 0)                 return static_cast<double>
...
class GenericObject {
  public:
    ...
    template <typename SourceAllocator> MemberIterator FindMember(const GenericValue<EncodingType, SourceAllocator>& name)
    const {
        return value_.FindMember(name);
    }
#if RAPIDJSON_HAS_STDSTRING
    ...
    template <typename T> RAPIDJSON_DISABLEIF_RETURN((
            internal::OrExpr<internal::IsPointer<T>, internal::IsGenericValue<T> >), (GenericObject)) AddMember(StringRefType name,
                    T value, AllocatorType& allocator) const {
        value_.AddMember(name, value, allocator);
        return *this;
    }
