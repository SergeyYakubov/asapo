...
wget http://nims.desy.de/extra/asapo/linux_packages/debian10.7/asapo-dev-@ASAPO_VERSION_IN_DOCS@-debian10.7.x86_64.deb
sudo apt install ./asapo-dev-@ASAPO_VERSION_IN_DOCS@-debian10.7.x86_64.deb
