...
const features = [
  {
    ...
    imageUrl: 'img/high-performance.png',
    description: (
      <>
  ...
  {
    title: 'Easy to Use',
    imageUrl: 'img/user-friendly.png',
    description: (
      <>
        ASAP::O API is avaiable in Python or C/C++ and is quite simple. Just couple lines of code and you can start using your data.
      </>
    ),
  },
];
