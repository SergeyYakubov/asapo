...
wget http://nims.desy.de/extra/asapo/linux_packages/debian10.7/asapo-dev-22.03.0-debian10.7.x86_64.deb
sudo apt install ./asapo-dev-22.03.0-debian10.7.x86_64.deb
