...
```python content="./versioned_examples/version-22.03.0/python/pipeline.py" snippetTag="pipeline"
```
...
```cpp content="./versioned_examples/version-22.03.0/cpp/pipeline.cpp" snippetTag="pipeline"
```
...
```python content="./versioned_examples/version-22.03.0/python/pipeline.py" snippetTag="finish"
```
...
```cpp content="./versioned_examples/version-22.03.0/cpp/pipeline.cpp" snippetTag="finish"
```
