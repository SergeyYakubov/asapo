...
```python content="./versioned_examples/version-21.09.0/python/consume.py"
```
...
```cpp content="./versioned_examples/version-21.09.0/cpp/consume.cpp"
```
...
```shell content="./versioned_examples/version-21.09.0/cpp/CMakeLists.txt" snippetTag="#consumer"
```
...
```c content="./versioned_examples/version-21.09.0/c/consume.c"
```
...
```makefile content="./versioned_examples/version-21.09.0/c/Makefile" snippetTag="#consumer"
```
