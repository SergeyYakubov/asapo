...
```python content="./versioned_examples/version-21.09.0/python/produce_dataset.py"
```
...
```cpp content="./versioned_examples/version-21.09.0/cpp/produce_dataset.cpp"
```
...
```python content="./versioned_examples/version-21.09.0/python/consume_dataset.py"
```
...
```cpp content="./versioned_examples/version-21.09.0/cpp/consume_dataset.cpp"
```
