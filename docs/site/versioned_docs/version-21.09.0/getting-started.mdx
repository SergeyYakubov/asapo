...
```shell content="./versioned_examples/version-21.09.0/start_asapo_socket.sh"
```
...
```shell content="./versioned_examples/version-21.09.0/start_asapo_tcp.sh"
```
...
```shell content="./versioned_examples/version-21.09.0/cleanup.sh"
```
...
```shell content="./versioned_examples/version-21.09.0/install_python_clients_pip.sh" snippetTag="#snippet1"
```

</TabItem>
<TabItem value="python-packages">

```shell content="./versioned_examples/version-21.09.0/install_python_clients_pkg.sh"
```

</TabItem>
<TabItem value="cpp">

```shell content="./versioned_examples/version-21.09.0/install_cpp_clients.sh"
```
