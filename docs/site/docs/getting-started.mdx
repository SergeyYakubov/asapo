...
```shell content="./examples/install_python_clients_pip.sh" snippetTag="#snippet1"
```

</TabItem>
<TabItem value="python-packages">

```shell content="./examples/install_python_clients_pkg.sh"
```

</TabItem>
<TabItem value="cpp">

```shell content="./examples/install_cpp_clients.sh"
```
