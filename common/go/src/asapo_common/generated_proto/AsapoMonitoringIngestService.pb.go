...
type ReceiverDataPointContainer struct {
	...
	ReceiverName          string                                 `protobuf:"bytes,1,opt,name=receiverName,proto3" json:"receiverName,omitempty"` // Hostname? or some kind of ID from receiver
...
type BrokerDataPointContainer struct {
	...
	BrokerName            string                    `protobuf:"bytes,1,opt,name=brokerName,proto3" json:"brokerName,omitempty"` // Hostname? or some kind of ID from broker
	TimestampMs           uint64                    `protobuf:"varint,2,opt,name=timestampMs,proto3" json:"timestampMs,omitempty"`
...
type FtsToConsumerDataPointContainer struct {
	...
	FtsName             string                    `protobuf:"bytes,1,opt,name=ftsName,proto3" json:"ftsName,omitempty"` // Hostname? or some kind of ID from fds
	TimestampMs         uint64                    `protobuf:"varint,2,opt,name=timestampMs,proto3" json:"timestampMs,omitempty"`
