...
class GenericRequest {
  public:
    ...
    bool TimedOut() {
        ...
        uint64_t elapsed_ms = std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::high_resolution_clock::now() -
                              created_at_).count();
  ...
  private:
    ...
    std::chrono::high_resolution_clock::time_point created_at_ = std::chrono::high_resolution_clock::now();
};
