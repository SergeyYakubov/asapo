...
ProducerRequestHandlerFactory::ProducerRequestHandlerFactory(ReceiverDiscoveryService* discovery_service): type_{RequestHandlerType::kTcp},
...
ProducerRequestHandlerFactory::ProducerRequestHandlerFactory(std::string destination_folder): type_{RequestHandlerType::kFilesystem},
