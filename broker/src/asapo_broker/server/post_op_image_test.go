...
func (suite *ImageOpTestSuite) TestImageOpOK() {
	query_str := "{\"Op\":\"Acknowledge\"}"
	suite.mock_db.On("ProcessRequest", expectedDBName, expectedSubstream, expectedGroupID, "ackimage", "1").Return([]byte(""), nil)
